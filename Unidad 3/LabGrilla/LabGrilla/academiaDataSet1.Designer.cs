...
namespace LabGrilla.academiaDataSet1TableAdapters {
...
SELECT id, tipo_doc, nro_doc, fecha_nac, apellido, nombre, direccion, telefono, email, celular, usuario, clave FROM usuarios WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LabGrilla.Properties.Settings.Default.academiaConnectionString;
        }
